...
// DATABASE_URL_TEST is unset, in which case every test self-skips — mirroring
// the internal/db harness so CI needs no live database.
var testPool *pgxpool.Pool

// TestMain wires up the test database. It reads DATABASE_URL_TEST directly
// (config.Load hard-requires DATABASE_URL) and applies the repo's migrations
